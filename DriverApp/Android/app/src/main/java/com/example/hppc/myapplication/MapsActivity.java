...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_distance = (Button) findViewById(R.id.btn_setLocation);
    ...
    private void getData(Bundle bundle) {
        ...
        try {
            ...
            double lat,lng;
            lat=data.getDouble("loc_lat");
            lng=data.getDouble("loc_lng");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(MapsActivity.this, "Clicked a Marker", Toast.LENGTH_SHORT).show();
                if (marker.equals(puneMarker)) {
                    Toast.makeText(MapsActivity.this, "pune", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
    ...
    public void onClick(View v) {
        if (v == button_distance)
        {
            ...
            try {
                searchQuery.put("ChangeStatus",3);
