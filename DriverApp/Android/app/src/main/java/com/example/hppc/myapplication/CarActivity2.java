...
public class CarActivity2 extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=(Button) findViewById(R.id.journey_completed);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    searchQuery.put("ChangeStatus",5);
                    searchQuery.put("regNo",data.getString("car_id"));
                    Log.d("cars", "onClick: request sent");
                } catch (JSONException e) {
                    e.printStackTrace();
                }

                RequestQueue queue = Volley.newRequestQueue(CarActivity2.this);
                PostRequestHandler handler=new PostRequestHandler("driverUpdateStatus",new ResponseObject() {
                    ...
                    public void onResponse(JSONObject res) {
                        ...
                        HomeActivity.setStage(5);
                        setResult(11);
                        startActivity(new Intent(CarActivity2.this, DriverActivity.class)
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(mumbai));
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(CarActivity2.this, "Clicked a Marker", Toast.LENGTH_SHORT).show();
                if (marker.equals(puneMarker)) {
                    Toast.makeText(CarActivity2.this, "pune", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
    ...
    public void onClick(View v) {
        if (v == button) {
            ...
            PostRequestHandler handler=new PostRequestHandler("driverUpdateStatus",new ResponseObject() {
                ...
                public void onResponse(JSONObject res) {
                    Log.d("cars", "onResponse: "+res.toString());
                    startActivity(new Intent(CarActivity2.this, DriverActivity.class));//This method will show the distance and will also draw the path
                }
            });
            StringRequest req =handler.postStringRequest(searchQuery);
            queue.add(req);
        ...
        mFusedLocationClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    myLocation = location;
                    Log.d("loc", "onSuccess: "+myLocation.toString());
                    getDirection();
                    zoomCamera();
                }
            }
    ...
    private void getDirection(){
        //Getting the URL
        String url = makeURL(19.0760, 72.8777,myLocation.getLatitude(),myLocation.getLongitude());
