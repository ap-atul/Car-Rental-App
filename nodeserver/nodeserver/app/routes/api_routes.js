...
module.exports = function(app, db) {
	...
	app.post('/notes', (req, res) => {
	    // You'll create your note here.
	   	...
	   	var a= Math.floor(Math.random()*2+1)%2;
	    res.json({message:a})
  	});
	...
	app.post('/notes/name', (req, res) => {
  	...
  	app.post('/notes/car', (req, res) => {
	    // You'll create your note here.
	   	console.log(req.body)
	    res.send('I drive a ferrari')
  	});
	...
	app.post('/reqOwner', (req, res) => {
		...
		userid = "himanshupalve1999@gmail.com"
			  ...
			  db.query(sql,[reg_no,email,nod,0,fair,city,reg_no,model_no,lat,lng,false,0],
			   function (err, result) {
				    if (err) {
						...
						fs.writeFileSync(__dirname + '/images/'+reg_no+'.jpg', decodedData);
